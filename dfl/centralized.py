...
class Centralized(Trainer):
    def __init__(self, trainer_input, clients, cfg, all_train, all_test, failure_schedule=None):
        Trainer.__init__(self, trainer_input, clients, cfg, all_train, all_test, failure_schedule=failure_schedule)
